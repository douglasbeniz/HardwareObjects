...
class Qt4_GraphicsManager(HardwareObject):
    ...
    def beam_info_changed(self, beam_info):
        ...
        """
        if beam_info:
            for graphics_item in list(self.graphics_view.graphics_scene.items()):
    ...
    def diffractometer_pixels_per_mm_changed(self, pixels_per_mm):
        ...
        if type(pixels_per_mm) in (list, tuple):
            if pixels_per_mm != self.pixels_per_mm:
                ...
                for item in list(self.graphics_view.graphics_scene.items()):
    ...
    def mouse_clicked(self, pos_x, pos_y, left_click=True):
        ...
        if self.in_centring_state:
            ...
            for graphics_item in list(self.graphics_view.scene().items()):
    ...
    def get_shapes(self):
        ...
        """
        shapes_list = []
        for shape in list(self.graphics_view.graphics_scene.items()):
    ...
    def select_lines_and_grids(self):
        ...
        for shape in list(self.shape_dict.values()):
